            ...
            link: function ($scope, $element, $attrs, $ngModelCtrl) {
                ...
                var updateSelectionLists = function () {
                    if (!$ngModelCtrl.$viewValue) {
                        ...
                        $scope.unselectedOptions = angular.copy($scope.resolvedOptions); // Take a copy
                    } else {
                ...
                $scope.selectAll = function () {
                    $scope.selectedOptions = $scope.resolvedOptions; // Take a copy;
                    $scope.unselectedOptions = [];
                };

                $scope.unselectAll = function () {
                    $scope.selectedOptions = [];
                    $scope.unselectedOptions = $scope.resolvedOptions; // Take a copy;
                };
...
angular.module("multiselect.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("multiselect.html",
    ...
    "        ng-style=\"{display: open ? 'block' : 'none'}\" style=\"max-height: 300px; width: 100%; overflow: auto\">\n" +
    "\n" +
