...
comercialApp.controller('comercialController', ['$scope', '$http', function ($scope, $http) {
    ...
    $scope.IrTiempoCompensatorio = function () {
        ...
        var ajaxColaboradoresTiempoCompensatorio = $http.post("comercial/colaboradores-tiempo-compensatorio/", {
            start: 0,
            limit: 0
        });
...
comercialApp.controller('vacacionesPermisos', ['$scope', '$http', function ($scope, $http) {
    ...
    var ajaxTiposPermisos = $http.post("comercial/tipos-permisos/", {});
    ...
    $scope.guardarVacaciones = function () {
        ...
        var ajaxVacaciones = $http.post("comercial/guardar-vacaciones/", {
    ...
    $scope.guardarPermisoColaborador = function () {
        ...
        var ajaxPermisos = $http.post("comercial/guardar-permiso/", {
            idColaborador: $scope.idTrabajador,
    ...
    $scope.verVacacionesColaborador = function (difYear) {
        ...
        var ajaxVerVacaciones = $http.post("comercial/ver-vacaciones-colaborador/", {
            idColaborador: $scope.idTrabajador,
            difYear: difYear
        });
    ...
    $scope.eliminarDiaVacaciones = function () {
        if ($scope.idDiaEliminar !== 0) {
            ...
            var eliminarVacacion = $http.post("comercial/eliminar-vacacion/", {
    ...
    $scope.buscarDatosDisponibilidad = function () {
        $scope.loading.show();
        var ajaxDatosDisponibilidad = $http.post('comercial/disponibilidad-recursos-fechas/', {
...
comercialApp.controller('tiemposCompensatorios', ['$scope', '$http', function ($scope, $http) {
    ...
    function tareasColaboradorTiempoCompensatorio(idColaborador, todos, cf) {
        ...
        var ajaxColaboradorTareasCompensatorias = $http.post("comercial/colaborador-tareas-compensatorias/", {
...
comercialApp.controller('marcasElectronicas', ['$scope', '$http', function ($scope, $http) {
    ...
    actualizarDatos = function (fechaLunes, jsonFiltro) {
        ...
        var ajaxMarcasElectronicas = $http.post("comercial/marcas-electronicas", {
            sede: sedeFiltro,
...
comercialApp.directive('ngRightClick', function ($parse) {
...
comercialApp.filter('filtroDisponibilidad', function () {
...
comercialApp.controller('incidenciasController', ['$scope', '$http', function ($scope, $http) {

    //Funciones de carga de datos
    $scope.cargarIncidencias = function (start, filtro) {
        $scope.loading.show();
        //Cargando las Incidencias
        var ajaxIncidencias = $http.post("comercial/incidencias-colaborador/", {
            start: start,       
            filtro: filtro
        });
    ...
    var ajaxColaboradores = $http.post("comercial/dar-colaboradores-modal-incidencias", {});
    ...
    $scope.GuardarIncidenciasColaboradores = function () {
        ...
        var ajaxIncidencias = $http.post("comercial/guardar-incidencias-colaborador/", {
